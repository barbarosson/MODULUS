  ...
  const caseStudies = [
    {
      ...
      testimonial: 'ModulusTech completely transformed our operations. The ROI was clear within the first quarter.',
    },
    {
      ...
      <div className="container-marketing">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            See how companies like yours achieved measurable success with ModulusTech
          </p>
        </div>

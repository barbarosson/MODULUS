        ...
        <div className="mt-16 text-center">
          <div className="inline-flex items-center gap-8 p-6 bg-white rounded-2xl shadow-sm">
            <div className="text-center">
              ...
              <div className="text-sm text-muted-foreground">{t.marketing.socialProof.activeUsers}</div>
            </div>
            <div className="w-px h-12 bg-border"></div>
            <div className="text-center">
              <div className="text-3xl font-bold text-primary">98%</div>
              <div className="text-sm text-muted-foreground">{t.marketing.socialProof.satisfactionRate}</div>
            </div>
            <div className="w-px h-12 bg-border"></div>
            <div className="text-center">
              <div className="text-3xl font-bold text-primary">50M+</div>
              <div className="text-sm text-muted-foreground">{t.marketing.socialProof.transactions}</div>
            </div>
          </div>
        </div>
      </div>

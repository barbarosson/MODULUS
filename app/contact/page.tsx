      ...
      <MarketingLayout>
        <section className="pt-32 pb-24 lg:pt-40 lg:pb-32 min-h-screen flex items-center">
          <div className="container-marketing">
            <Card className="max-w-2xl mx-auto p-12 text-center border-2 border-[#2ECC71] bg-gradient-to-br from-white to-green-50">
              <div className="w-20 h-20 bg-[#2ECC71] rounded-full flex items-center justify-center mx-auto mb-6">
                <CheckCircle2 className="h-10 w-10 text-white" />
              </div>
              <h2 className="text-3xl font-bold mb-4">{t.marketing.contact.thankYou}</h2>
          ...
          <div className="grid lg:grid-cols-3 gap-12 max-w-6xl mx-auto">
            <div className="lg:col-span-2">
              <Card className="p-8 lg:p-12">
                <h2 className="text-2xl font-bold mb-6">{t.marketing.contact.requestDemo}</h2>
            ...
            <div className="space-y-6">
              <Card className="p-6">
                <h3 className="font-semibold mb-4">{t.marketing.contact.whatToExpect}</h3>
                    ...
                    return (
                      <div key={index} className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <div className="text-sm text-[#475569]">{info.value}</div>
                        </div>
                      </div>
                    )
                  })}
              ...
              <Card className="p-6 bg-primary/5 border-primary/20">
                <div className="space-y-2">
                  <div className="text-2xl font-bold text-primary">{t.marketing.contact.responseTime}</div>
                  <p className="text-sm text-[#475569]">

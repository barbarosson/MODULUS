          ...
          <Card className="border-2 border-emerald-200">
            <CardContent className="pt-8 pb-8 text-center space-y-6">
              ...
              <div className="space-y-2">
                <h2 className="text-2xl font-bold text-gray-900">{l.checkEmail}</h2>
                <p className="text-gray-600">
                  <span className="font-semibold text-emerald-600">{registeredEmail}</span>
                  {' '}
                  {language === 'tr'
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-md space-y-6">
        <div className="text-center space-y-2">
          ...
          <h2 className="text-3xl font-bold text-gray-900">{l.welcome}</h2>
        ...
        <div className="text-center space-y-2">
          <div className="bg-gradient-to-r from-[#2ECC71]/10 to-blue-50 rounded-lg p-4 mb-4">
            <p className="text-sm text-gray-700 mb-3">{l.demoRequestInfo}</p>
            <Button
              className="w-full bg-gradient-to-r from-[#2ECC71] to-[#27AE60] hover:from-[#27AE60] hover:to-[#229954]"
